...
namespace AnestesistaNew.Interface
{
    ...
    partial class AutoGeneratedInterfaceControlador : InterfaceControlador        {
        ...
        /// <inheritdoc />
        public virtual Task<EStatus> ConsultarStatusAnestesista(string identificador)
        {
            var arguments = new object[] { identificador };
            var func = requestBuilder.BuildRestResultFuncForMethod("ConsultarStatusAnestesista", new Type[] { typeof(string) });
